...
// });
  ...
  Route::POST('/auth/reset-password',[App\Http\Controllers\ApiControllers\Auth\ResetPasswordController::Class,"do_reset"]);
    ...
    Route::get('/support',[App\Http\Controllers\ApiControllers\CmsController::Class,"support"]);
...
// });
  ...
  Route::group(["middleware" => "auth:api"],function(){ 
    ...
    Route::POST('/isralite_info',[App\Http\Controllers\ApiControllers\UsersController::Class,"isralite_info"]);
    Route::POST('/more_about_me',[App\Http\Controllers\ApiControllers\UsersController::Class,"more_about_me"]);
    Route::POST('/portfolio',[App\Http\Controllers\ApiControllers\UsersController::Class,"portfolio"]);
